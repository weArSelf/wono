...
#define BACKGROUND_BLACK_COLOR [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3]
...
- (void)dissView{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.containerView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, pickerViewHeight);
...
- (UIButton *)confirmButton{
    if (!_confirmButton) {
        ...
        [_confirmButton setTitleColor:MainColor forState:UIControlStateNormal];
