...
#define LineColor2 UIColorFromHex(0x4cb566)
...
-(void)createTitle{
    ...
    firLabel.textColor = [UIColor grayColor];
    ...
    secLabel.textColor = [UIColor grayColor];
    secLabel.text = @"支出";
    ...
    _ZtitleLabel.textColor = [UIColor grayColor];
    _ZtitleLabel.font = [UIFont systemFontOfSize:14];
    _ZtitleLabel.text = @"本年度总月收入和支出";
    
    _ZtitleLabel.frame = CGRectMake(HDAutoWidth(10), HDAutoHeight(15), HDAutoWidth(400), HDAutoHeight(60));
    [self addSubview:_ZtitleLabel];
