...
-(void)getdata{
    ...
    [[InterfaceSingleton shareInstance].interfaceModel getPengWithCatPid:@"0" WithType:@"1" AndCallBack:^(int state, id data, NSString *msg) {
...
-(void)labelClick2:(UITapGestureRecognizer *)recognizer{
    ...
    ZhongZhiTypeViewController *plant = [[ZhongZhiTypeViewController alloc]init];
