...
@interface PlantTypeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PlantTypeViewController{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[InterfaceSingleton shareInstance].interfaceModel getPengWithCatPid:pid WithType:@"3" AndCallBack:^(int state, id data, NSString *msg) {
        ...
        if(state == 2000){
            ...
            PlantTypeViewController *pengtype = [[PlantTypeViewController alloc]init];
...
//            [self.navigationController popViewControllerAnimated:YES];
            ...
            for (UIViewController *controller in self.navigationController.viewControllers) {
                if ([controller isKindOfClass:[ZhiBaoViewController class]]) {
                    ZhiBaoViewController *A =(ZhiBaoViewController *)controller;
                    [self.navigationController popToViewController:A animated:YES];
                }
            }
