//
//  ZhongZhiTypeViewController.m
//  wonoAPP
//
//  Created by IF on 2017/9/25.
//  Copyright © 2017年 IF. All rights reserved.
//

#import "ZhongZhiTypeViewController.h"
#import "ZhongZhiViewController.h"


@interface ZhongZhiTypeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ZhongZhiTypeViewController{
...
//    PengTypeModel *model = _NowdataArr[indexPath.row];
    ...
    [[InterfaceSingleton shareInstance].interfaceModel getPengWithCatPid:pid WithType:@"1" AndCallBack:^(int state, id data, NSString *msg) {
        ...
        if(state == 2000){
            ...
            ZhongZhiTypeViewController *pengtype = [[ZhongZhiTypeViewController alloc]init];
        ...
        if(state == 2001){
            ...
            for (UIViewController *controller in self.navigationController.viewControllers) {
                if ([controller isKindOfClass:[ZhongZhiViewController class]]) {
                    ZhongZhiViewController *A =(ZhongZhiViewController *)controller;
                    [self.navigationController popToViewController:A animated:YES];
                }
            }
