...
@interface CaiShouTypeViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CaiShouTypeViewController{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [[InterfaceSingleton shareInstance].interfaceModel getPengWithCatPid:pid WithType:@"4" AndCallBack:^(int state, id data, NSString *msg) {
        ...
        if(state == 2000){
            ...
            CaiShouTypeViewController *pengtype = [[CaiShouTypeViewController alloc]init];
        ...
        if(state == 2001){
            ...
            for (UIViewController *controller in self.navigationController.viewControllers) {
                if ([controller isKindOfClass:[WorkViewController class]]) {
                    WorkViewController *A =(WorkViewController *)controller;
                    [self.navigationController popToViewController:A animated:YES];
                }
            }
